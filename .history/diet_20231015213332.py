...
milk_whole = Food("Whole Milk", 60, 3.22, 4.52, 3.25)           # 100 g
milk_semi_skimmed = Food("Semi-Skimmed Milk", )                 # 100 g
milk_skimmed = Food("Skimmed Milk", )                           # 100 g
milk_soy = Food("Soy Milk", 54, 3.27, 6.28, 1.75)               # 100 g

def main ()
    while Trueprint("Choose an option:\n")
    print("1. Add meal")
    print("2. Edit meal")
    print("3. ")